...
from Utils.network_utils import batch_pack_graph
...
def mrcnn_class_loss_graph(target_class_ids, pred_class_logits, active_class_ids):
    ...
    active_class_ids: [batch, num_classes].
        Has a value of 1 for classes that are in the dataset of the image, and
        0 for classes that are not in the dataset.
    """
    # During model building, Keras calls this function with
    # target_class_ids of type float32. Unclear why. Cast it to int to get around it.
