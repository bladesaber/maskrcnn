...
from Utils.network_utils import norm_boxes_graph, parse_image_meta_graph, compute_backbone_shapes, compose_image_meta
import numpy as np
from model.Rpn import build_rpn_model
from model.Proposal import ProposalLayer
from model.Fpn import fpn_classifier_graph, build_fpn_mask_graph
from model.Detection import DetectionTargetLayer, DetectionLayer
from model.loss import *
from Utils.utils import generate_pyramid_anchors, norm_boxes, log, resize_image, denorm_boxes, unmold_mask
from data.DataGenerator import data_generator, mold_image
    ...
    def build(self, mode, config):
        ...
        if mode == "training":
            ...
            rois, target_class_ids, target_bbox, target_mask = DetectionTargetLayer(
                config, name="proposal_targets")([target_rois, input_gt_class_ids, gt_boxes, input_gt_masks])
...
if __name__ == '__main__':
    ...
    # dataset_val.prepare()
    #
    # model = MaskRCNN(mode="training", config=config, model_dir='D:/coursera/maskrcnn/checkpoint')
